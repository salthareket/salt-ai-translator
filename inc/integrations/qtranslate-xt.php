...
/* * qTranslate-XT Fonksiyonlarını İçe Aktar */
use function qtranxf_getSortedLanguages;
use function qtranxf_getLanguageName;
use function qtranxf_use;
use function qtranxf_join_texts;
use function qtranxf_split_clauses;
