...
/* * WordPress Fonksiyonlarını İçe Aktar */
use function get_post_meta;
use function update_post_meta;
use function render_block;
use function get_post_custom_keys;
use function get_post_custom_values;
